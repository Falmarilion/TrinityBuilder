...
set sourcepath=TrinityCore
set repo=https://github.com/Falmarilion/TrinityCore-Single-Player.git
set branch=master
set arch=
set archpath=Win64
...
echo
type "%mainfolder%\Build\%sourcepath%_%archpath%\bin\release\configs\authserver.conf.dist" | "%mainfolder%\Tools\repl.bat" "127.0.0.1;3306;trinity;trinity;auth" "127.0.0.1;3310;root;123456;auth" > "%mainfolder%\Build\%sourcepath%_%archpath%\bin\release\configs\authserver.conf.dist1"
...
type "%mainfolder%\Build\%sourcepath%_%archpath%\bin\release\configs\worldserver.conf.dist" | "%mainfolder%\Tools\repl.bat" "127.0.0.1;3306;trinity;trinity;auth" "127.0.0.1;3310;root;123456;auth" > "%mainfolder%\Build\%sourcepath%_%archpath%\bin\release\configs\worldserver.conf.dist1"
type "%mainfolder%\Build\%sourcepath%_%archpath%\bin\release\configs\worldserver.conf.dist1" | "%mainfolder%\Tools\repl.bat" "127.0.0.1;3306;trinity;trinity;world" "127.0.0.1;3310;root;123456;world" > "%mainfolder%\Build\%sourcepath%_%archpath%\bin\release\configs\worldserver.conf.dist2"
type "%mainfolder%\Build\%sourcepath%_%archpath%\bin\release\configs\worldserver.conf.dist2" | "%mainfolder%\Tools\repl.bat" "127.0.0.1;3306;trinity;trinity;characters" "127.0.0.1;3310;root;123456;characters" > "%mainfolder%\Build\%sourcepath%_%archpath%\bin\release\configs\worldserver.conf.dist3"
...
for %%i in ("%mainfolder%\Repack\modules_sql\*sql") do if %%i neq "%mainfolder%\Repack\modules_sql\*sql" if %%i neq "%mainfolder%\Repack\modules_sql\*sql" if %%i neq "%mainfolder%\Repack\modules_sql\*sql" echo %%i & "%mainfolder%\Tools\database\%database%-%archpath%\bin\mysql.exe" --defaults-extra-file="%mainfolder%\Tools\database\%database%-%archpath%\connection.cnf" --default-character-set=utf8 --database=characters < %%i
for %%i in ("%mainfolder%\Repack\modules_sql\*sql") do if %%i neq "%mainfolder%\Repack\modules_sql\*sql" if %%i neq "%mainfolder%\Repack\modules_sql\*sql" if %%i neq "%mainfolder%\Repack\modules_sql\*sql" echo %%i & "%mainfolder%\Tools\database\%database%-%archpath%\bin\mysql.exe" --defaults-extra-file="%mainfolder%\Tools\database\%database%-%archpath%\connection.cnf" --default-character-set=utf8 --database=world < %%i
"%mainfolder%\Tools\database\%database%-%archpath%\bin\mysql.exe" --defaults-extra-file="%mainfolder%\Tools\database\%database%-%archpath%\connection.cnf" --default-character-set=utf8 --database=world < "%mainfolder%\Source\%sourcepath%\src\server\game\Robot\robot_names.sql"
cd "%mainfolder%"
cls
